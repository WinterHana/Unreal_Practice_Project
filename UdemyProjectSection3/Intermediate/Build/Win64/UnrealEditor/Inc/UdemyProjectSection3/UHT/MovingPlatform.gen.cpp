...
#include "UdemyProjectSection3/MovingPlatform.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMovingPlatform() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UDEMYPROJECTSECTION3_API UClass* Z_Construct_UClass_AMovingPlatform();
	UDEMYPROJECTSECTION3_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
	UPackage* Z_Construct_UPackage__Script_UdemyProjectSection3();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMovingPlatform_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_UdemyProjectSection3,
	};
#if WITH_METADATA
	...
	template<> UDEMYPROJECTSECTION3_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	AMovingPlatform::~AMovingPlatform() {}
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_Unreal_Practice_Project_UdemyProjectSection3_Source_UdemyProjectSection3_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Unreal_Practice_Project_UdemyProjectSection3_Source_UdemyProjectSection3_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2981864040U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Unreal_Practice_Project_UdemyProjectSection3_Source_UdemyProjectSection3_MovingPlatform_h_1312649530(TEXT("/Script/UdemyProjectSection3"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Unreal_Practice_Project_UdemyProjectSection3_Source_UdemyProjectSection3_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Unreal_Practice_Project_UdemyProjectSection3_Source_UdemyProjectSection3_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
